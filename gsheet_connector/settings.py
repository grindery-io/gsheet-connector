"""
Django settings for gsheet_connector project.
...
ROOT_URLCONF = 'gsheet_connector.urls'
...
WSGI_APPLICATION = 'gsheet_connector.wsgi.application'
# Channels
ASGI_APPLICATION = "gsheet_connector.asgi.application"
CHANNEL_LAYERS = {
    'default': {
